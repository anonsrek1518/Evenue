...
Class Action {
    ...
    function save_settings(){
        ...
        if($save){
            ...
            return 1; // Settings saved successfully
        }
    }
    ...
    function save_venue(){
        ...
        if($save)
            return 1; // Venue saved successfully
    }
    ...
    function delete_venue(){
        ...
        if($delete){
            return 1; // Venue deleted successfully
        }
    }
    ...
    function save_book(){
        ...
        if($save)
            return 1; // Booking saved successfully
    }
    ...
    function delete_book(){
        ...
        if($delete){
            return 1; // Booking deleted successfully
        }
    }

    // Function to save audience registration data
    function save_register(){
        ...
        if($save)
            return 1; // Registration saved successfully
    }

    // Function to delete an audience registration
    function delete_register(){
        extract($_POST);
        $delete = $this->db->query("DELETE FROM audience where id = ".$id);
        if($delete){
            return 1; // Registration deleted successfully
        }
    }
    ...
    function save_event(){
        ...
        if($save)
            return 1; // Event saved successfully
    }
    ...
    function delete_event(){
        ...
        if($delete){
            return 1; // Event deleted successfully
        }
    }
    
    // Function to get audience report
    function get_audience_report(){
        ...
        return json_encode($data); // Returning audience report data
    }

    // Function to get venue report
    function get_venue_report(){
        ...
        return json_encode($data); // Returning venue report data
    }

    // Function to save art for sale
    function save_art_fs(){
        ...
        if($save){
            ...
            return json_encode(array("status"=>1,"id"=>$id)); // Art for sale saved successfully
        }
    }

    // Function to delete art for sale
    function delete_art_fs(){
        extract($_POST);
        $delete = $this->db->query("DELETE FROM arts_fs where id = ".$id);
        if($delete){
                return 1; // Art for sale deleted successfully
            }
    }
    ...
    function delete_order(){
        ...
        if($delete){
                return 1; // Order deleted successfully
            }
    }
    ...
    function update_order(){
        ...
        if($order_id){
            ...
            if($fs)
            return 1; // Order updated successfully
        }
    }
} 
